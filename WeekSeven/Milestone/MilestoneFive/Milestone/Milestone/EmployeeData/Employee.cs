...
namespace Milestone.EmployeeData
{
    ...
    {
        //auto-increment value for employee id
        ...
        //assignment constructor with ID
        public Employee(int id, string name, decimal wage, string position, string department)
        {
            //adjust current running id
            if(id >= _currentEmployeeId)
            {
                _currentEmployeeId = id + 1;
            }
